...
<link rel="stylesheet" href="{{ asset('public/css/backend_css/colorpicker.css')}}" />
<link rel="stylesheet" href="{{ asset('public/css/backend_css/datepicker.css')}}" />
...
<link rel="stylesheet" href="{{ asset('public/css/backend_css/bootstrap-wysihtml5.css')}}" />
...
<script src="{{ asset('public/js/backend_js/excanvas.min.js')}}"></script> 
...
<script src="{{ asset('public/js/backend_js/jquery.flot.min.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/jquery.flot.resize.min.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/jquery.peity.min.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/fullcalendar.min.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/matrix.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/matrix.dashboard.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/jquery.gritter.min.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/matrix.interface.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/matrix.chat.js')}}"></script> 
...
<script src="{{ asset('public/js/backend_js/jquery.wizard.js')}}"></script> 
...
<script src="{{ asset('public/js/backend_js/bootstrap-colorpicker.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/bootstrap-datepicker.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/jquery.toggle.buttons.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/masked.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/matrix.form_common.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/bootstrap-colorpicker.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/wysihtml5-0.3.0.js')}}"></script> 
<script src="{{ asset('public/js/backend_js/bootstrap-wysihtml5.js')}}"></script> 
