                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                     ...
                     <a href="{{ route('auction.update', ['auction_id'=>$auction->id]) }}" class="btn btn-primary btn-mini">Edit</a> 
                      ...
                      <a href="{{ route('auction.bidlistingByProduct', ['product_id'=>$auction->product->id,'auction_id'=>$auction->id]) }}" class="btn btn-warning btn-mini">Bids Placed</a> 
                      <a href="javascript:void(0);" class="btn btn-info btn-mini">View Winner</a> 
