...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ route('admin.dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ url('admin/list-categories') }}">Categories</a> <a href="{{ url('admin/edit-category') }}" class="current">Edit Category</a> </div>
    <h1>Categories</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>Edit Category</h5>
            <div class="buttons"> <a href="{{ url('admin/list-categories') }}" class="btn btn-info btn-mini"> Back</a></div>
          </div>
